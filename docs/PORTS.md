...
`전체 초기화` 는 곡 정보를 지우지 않는다. 전체 초기화의 의미는 "배치 지우기"이지 "곡 정보 폐기"가 아니다. 만약 지우도록 넓힌다면 되돌리기 장치와 확인 문구를 **같은 커밋에서** 함께 손봐야 한다([개발 원칙 R-4](PRINCIPLES.md#r-4)). 링크가 지금 그 규칙을 어긴 채로 남아 있다.
